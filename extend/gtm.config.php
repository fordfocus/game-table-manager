 ...
 * 다운로드 메뉴
 */
define('GTM_ADMIN_DOWNLOAD_DIR', 'download');
define('GTM_ADMIN_DOWNLOAD_URL', GTM_ADMIN_URL.'/'.GTM_ADMIN_DOWNLOAD_DIR.'');
define('GTM_ADMIN_DOWNLOAD_PATH', GTM_ADMIN_PATH.'/'.GTM_ADMIN_DOWNLOAD_DIR.'');
