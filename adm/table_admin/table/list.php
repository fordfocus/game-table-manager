            ...
            <table>
                ...
                for ($i = 0; $row = sql_fetch_array($result); $i++) {
                    ...
                    <tr class="<?php echo $bg; ?>">
                        ...
                        <td class="">
                            <a href="./view.php?id=<?php echo $row['id'] ?>" class="btn btn_03">테이블 보기</a>
                            <a href="<?=GTM_ADMIN_MAKE_COLUMN_URL . '/form.php'?>?table_id=<?php echo $row['id'] ?>" class="btn btn_01">컬럼 추가</a>
                        </td>
                    </tr>
